    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // address1=findViewById(R.id.address1);
        ...
        if(intent.getStringExtra("from").equals("edit")){
            ...
            update.setText("Add");
            current.setText("Add Current Location");
        }
                ...
                if(validation()){
                    if(latitude!=null && longitude !=null) {
                        ...
                        if(currentfrom.equals("true")) {
                            Toast.makeText(AddAddress.this, "Please check Gps and try again", Toast.LENGTH_LONG).show();
                        }else{
                            Toast.makeText(AddAddress.this, "Please select the location from the recomended location in the nearlocation field ", Toast.LENGTH_LONG).show();
              ...
              //  Log.d("resss",resource.toString());
                ...
                if(resource.getStatus().equals("ok")){
                    ...
                    if(resource.getMessage()!=""){
                        Toast.makeText(AddAddress.this, resource.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }
...
//        }
        ...
        Call<MyProfileResponce> getCate = ApiClient.getApiService().addAddressFriend("add",id,address.getText().toString()+"\nLandMark : "+landmark.getText().toString(),pincode.getText().toString(),
                city.getText().toString(),name.getText().toString(),phnnum.getText().toString(),latitude,longitude,seller_type);
        getCate.enqueue(new Callback<MyProfileResponce>() {
            @Override
            public void onResponse(Call<MyProfileResponce> call, Response<MyProfileResponce> response) {
...
//        }
        if(name.getText().toString().trim().length()==0){
            Toast.makeText(AddAddress.this,"please fill name field",Toast.LENGTH_SHORT).show();
            return  false;
        }else    if(name.getText().toString().trim().length()<3){
            Toast.makeText(AddAddress.this,"please enter name minimum 3 characters",Toast.LENGTH_SHORT).show();
            return  false;
        }else if(phnnum.getText().toString().trim().length()==0){
            Toast.makeText(AddAddress.this,"please fill phone number field",Toast.LENGTH_SHORT).show();
            return  false;
        }else     if(phnnum.getText().toString().trim().length()!=10){
            Toast.makeText(AddAddress.this,"please enter 10 digits phone number",Toast.LENGTH_SHORT).show();
            return  false;
        } else     if(address.getText().toString().trim().length()==0){
            Toast.makeText(AddAddress.this,"please fill address field",Toast.LENGTH_SHORT).show();
            return  false;
        } else     if(landmark.getText().toString().trim().length()==0){
            Toast.makeText(AddAddress.this,"please fill landmark field",Toast.LENGTH_SHORT).show();
            return  false;
        }else
        if(landmark.getText().toString().trim().length()<3){
            Toast.makeText(AddAddress.this,"landmark field should contain atleast 3 charesters",Toast.LENGTH_SHORT).show();
            return  false;
            ...
            Toast.makeText(AddAddress.this,"Enter Valid Pincode ",Toast.LENGTH_SHORT).show();
            return  false;
        }
