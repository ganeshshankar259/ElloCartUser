 ...
 * Use the {@link FeaturedBottomSheet#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FeaturedBottomSheet extends Fragment implements     TrendingAdapter.OnItemClickeGrid{
    ProgressDialog pd1;
    ...
    public static FeaturedBottomSheet newInstance(String param1, String param2) {
        FeaturedBottomSheet fragment = new FeaturedBottomSheet();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        current.setText("Featured Stores");
        ontrend=this;
        trendingApi();
        return view;
    }
...
//                    datalayout.setVisibility(View.GONE);
    ...
    public void onItemClickedtrend(int position, String mParam1, String storename, String catid, String sellerid, String storestatus) {
        ...
        Util.loadFragment(CategoryFragment.newInstance(catid, sellerid, storename), getActivity(),FeaturedBottomSheet.this);
    }
