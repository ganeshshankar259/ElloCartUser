...
public class RecentLocationAdapter extends RecyclerView.Adapter<RecentLocationAdapter.ViewHolderNear> {
    ...
    Context ctx;
    //declare interface
    RecentLocationAdapter.OnItemClickedAdd onClick;

    public RecentLocationAdapter(Context ctx, List<Address> datalist, RecentLocationAdapter.OnItemClickedAdd onclick){
    ...
    @NonNull
    @Override
    public RecentLocationAdapter.ViewHolderNear onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.recentaddresssingle,parent,false);
        return new RecentLocationAdapter.ViewHolderNear(view);
    }
    @Override
    ...
    @Override
    public void onBindViewHolder(@NonNull RecentLocationAdapter.ViewHolderNear holder, int position) {
