...
public class OffersAdapterNew extends RecyclerView.Adapter<OffersAdapterNew.ViewHolder> {
    ...
    public OffersAdapterNew(Context ctx, List<Stores> datalist, String clr, OffersAdapterNew.OnItemClickeGrid onItemClickeGrid, int Layout){
