...
public class AllIndiaAdapterNew extends RecyclerView.Adapter<AllIndiaAdapterNew.ViewHolder> {
    ...
    public AllIndiaAdapterNew(Context ctx, List<Categories> datalist, AllIndiaAdapterNew.OnItemClickeGrid onItemClickeGrid, int layout){
