...
public class TrendingAdapter extends RecyclerView.Adapter<TrendingAdapter.ViewHolder> {
    ...
    List<String> titles;
    List<TrendStore> datalist;
    LayoutInflater inflater;
    TrendingAdapter.OnItemClickeGrid onItemClickeGrid;
int layout;
    public TrendingAdapter(Context ctx, List<TrendStore> datalist, TrendingAdapter.OnItemClickeGrid onItemClickeGrid,int layout){
