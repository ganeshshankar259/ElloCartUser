...
public class WishListB2BAdapter extends RecyclerView.Adapter<WishListB2BAdapter.ViewHolderNear> {
    ...
    public WishListB2BAdapter(Context ctx, List<Stores> datalist, OnItemClickedNear  onclick){
